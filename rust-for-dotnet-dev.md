...
authors writing Rust code over the course of several months. It is the
document the authors wish they had when they started on their Rust journey.
That said, the authors would encourage you to read books and other material
available on the Web to embrace Rust and its idioms rather than attempting to
learn it exclusively through the lens of C# and .NET. Meanwhile, this document
can help answers some question quickly, like: _Does Rust support inheritance,
...
- While there are short examples that contrast C# and Rust code for some
  topics, this document is not meant to be a cookbook of coding recipes in the
  two languages.
...
- [Language](#language)
  ...
  - [Enumeration types (`enum`)](#enumeration-types-enum)
  - [Members](#members)
    - [Constructors](#constructors)
    - [Methods (static & instance-based)](#methods-static--instance-based)
    - [Constants](#constants)
    - [Events](#events)
  ...
  - [Nullability and Optionality](#nullability-and-optionality)
    - [Control flow with optionality](#control-flow-with-optionality)
...
- [Testing](#testing)
  ...
  - [Output in tests](#output-in-tests)
...
- [LINQ](#linq)
  ...
  - [Operators](#operators)
  - [Deferred execution (laziness)](#deferred-execution-laziness)
  - [Iterator Methods (`yield`)](#iterator-methods-yield)
...
- [Asynchronous Programming](#asynchronous-programming)
  ...
  - [Executing multiple Tasks](#executing-multiple-tasks)
...
This alternative is suggested in the case you would like to experiment, i.e.,
with [cargo dependencies](#dependencies) or [code coverage](#code-coverage).
